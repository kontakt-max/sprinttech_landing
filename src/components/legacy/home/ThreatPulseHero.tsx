      ...
      <div className="container-wide relative section-padding pb-8">
        <div className="grid items-start gap-10 xl:grid-cols-2 xl:gap-12">
          <div className="max-w-xl">
            ...
            <h1 className="text-4xl font-bold leading-[1.08] tracking-tight text-balance sm:text-5xl lg:text-6xl xl:text-7xl">
              {homeHero.h1}
            </h1>
            ...
            <button
              ...
              className="mt-4 inline-flex items-center gap-1 text-sm text-cyber-cyan hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyber-cyan rounded"
            >
