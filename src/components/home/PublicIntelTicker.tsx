...
export function PublicIntelTicker({ initialData, showSources = true }: PublicIntelTickerProps) {
  ...
  if (loading) {
    return (
      <div className="space-y-3" aria-busy="true" aria-label="Ładowanie danych threat pulse">
        {[1, 2, 3].map((i) => (
